var curso1 = [{
    ...
    {
        nombre: "TomÃ¡s Ercilla",
        calificaciones: [5.9, 6.2, 6.3, 6.5]
    },
    {
        nombre: "Daniela FernÃ¡ndez",
    ...
    {
        nombre: "GermÃ¡n Uturriaga",
        calificaciones: [3.6, 4.2, 4.5, 3.9]
    },
    {
        nombre: "Javiera VÃ©liz",
        calificaciones: [2.5, 1.9, 4.2, 3.5]
    },
    {
        nombre: "Paola YÃ¡Ã±ez",
...
document.querySelector("div").innerHTML = JSON.stringify(myArray);